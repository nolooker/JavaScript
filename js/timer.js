...
const clockH = document.querySelector("h2#timer span:first-child");
const clockM = document.querySelector("h2#timer span:nth-child(2)");
const clockS = document.querySelector("h2#timer span:last-child");
